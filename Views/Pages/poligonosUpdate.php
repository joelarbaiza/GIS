...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['id_poligono']) && is_numeric($_POST['id_poligono'])) {
        $id = intval($_POST['id_poligono']);

        $datos = $pdo->query("SELECT p.id_poligono, e.nombre_comercial, p.id_empresa, p.p1,p.p2 ,p.p3,p.p4, p.ubicacion_1 , p.ubicacion_2, p.ubicacion_3  
    from poligono p inner join empresa e on p.id_empresa =e.id_empresa where p.id_poligono = $id");
                ...
                <div class="container pt-3">
                    <div class="card mx-auto" style="max-width: 1200px;">
                        <div class="card-header">
                            <label class="card-title"><i class="fas fa-draw-polygon pr-1"></i> Actualizar Polígono</label>
                        </div>
                                ...
                                <div class="form-row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <select class="form-control" id="id_empresa" name="id_empresa" required>
                                            ...
                                            $empresas = $insPoligono->listarEmpresas();

                                            foreach ($empresas as $empresa) :
                                                $selected = ($empresa['id_empresa'] == $id_empresa) ? 'selected' : '';
                                            ?>
                                                <option value="<?php echo htmlspecialchars($empresa['id_empresa']); ?>" <?php echo $selected; ?>><?php echo htmlspecialchars($empresa['nombre_comercial']); ?></option>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" id="p1" class="form-control" name="p1" placeholder="Punto 1" required id="p1" value="<?php echo $p1; ?>">
                                    </div>

                                    <div class="col-md-4 mb-3">
                                        <label for="p2" class="text-secondary">Punto 2</label>
                                        <input type="text" class="form-control" id="p2" name="p2" placeholder="Punto 2" required id="p2" value="<?php echo $p2; ?>">
                                    </div>

                                    <div class="col-md-4 mb-3">
                                        <label for="p3" class="text-secondary">Punto 3</label>
                                        <input type="text" class="form-control" id="p3" name="p3" placeholder="Punto 3" required id="p3" value="<?php echo $p3; ?>">
                                    </div>

                                    <div class="col-md-4 mb-3">
                                        <label for="p4" class="text-secondary">Punto 4</label>
                                        <input type="text" class="form-control" id="p4" name="p4" placeholder="Punto 4" required id="p4" value="<?php echo $p4; ?>">
                                    </div>
                                </div>

                                <div class="text-right mt-2">
                                    <button type="submit" class="btn btn-success"><i class="fas fa-check-circle pr-2"></i>Actualizar Polígono</button>
                                    <a href="poligonos" class="btn btn-danger"><i class="fas fa-times-circle pr-2"></i>Cancelar</a>
                                </div>
                            </form>
                        </div>
                    </div>
